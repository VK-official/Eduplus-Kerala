...
export function ThemeToggle() {
  ...
  return (
    <button
      ...
      className="relative inline-flex h-9 w-9 items-center justify-center rounded-md border border-slate-200/50 bg-white/50 hover:bg-slate-100/50 dark:border-slate-800/50 dark:bg-black/50 dark:hover:bg-slate-800/50 backdrop-blur-sm transition-colors"
      title="Toggle theme"
    >
